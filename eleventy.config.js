...
const markdownLib = markdownIt(markdownItOptions).use(mdfigcaption, figoptions, markdownItAttrs);
...
module.exports = function(eleventyConfig) {
	...
	eleventyConfig.addFilter('htmlDateString', (dateObj) => {
		...
		return DateTime.fromJSDate(dateObj, {zone: 'utc'}).setLocale('fr').toFormat('dd-LL-yyyy');
	});
